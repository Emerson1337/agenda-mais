import { AppointmentHistory } from "@/server-actions/fetchPhoneHistory";
        ...
        >
          <li className="ms-6 mb-2">
            <span className="absolute flex items-center justify-center w-6 h-6 bg-primary rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-primary">
              <svg
                className="w-2.5 h-2.5 text-primary-foreground dark:text-primary-foreground"
                aria-hidden="true"
            ...
            <h3 className="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">
              {appointment.phone}
              <span className="bg-primary text-primary-foreground text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-primary dark:text-primary-foreground ms-3">
                {appointment.status}
              </span>
            </h3>
            ...
            <a
              href="#"
              className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-primary-foreground focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-100 focus:text-primary-foreground dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700"
            >
              <svg
