          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-secondary sm:text-lg sm:leading-[1.44]">
                  Crie a sua agenda, os seus serviços e proporcione uma maneira
                  fácil para os seus clientes agendarem os seus horários.{" "}
                ...
                <div>
                  <p className="mb-4 text-center text-base font-medium text-secondary/60">
                    Ideal para empreendedores com atendimento ao público
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <div className="absolute text-secondary -right-6 -top-6 z-[-1]">
                  <Dots />
                </div>
              </div>
            </div>
