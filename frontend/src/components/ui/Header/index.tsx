          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                <nav
                  id="navbarCollapse"
                  className={`navbar absolute right-0 z-30 w-[250px] rounded border-[.5px] border-body-color/50 bg-black px-6 py-4 duration-300 dark:border-body-color/20 dark:bg-dark-2 lg:visible lg:static lg:w-auto lg:border-none lg:!bg-transparent lg:p-0 lg:opacity-100 lg:dark:bg-transparent ${
                    navbarOpen
                        ...
                        <li key={index} className="group relative">
                          {pathUrl !== "/" ? (
                            <Link
                              ...
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex py-2 text-base  lg:inline-flex lg:px-0 lg:py-6 ${pathUrl === menuItem?.path && !sticky && "!text-primary"} ${pathUrl === menuItem?.path && sticky && "!text-primary"} ${
                                sticky
                                  ? "lg:text-secondary-foreground text-white"
                                  : "lg:text-secondary-foreground text-white "
                              }`}
                            >
                              {menuItem.title}
                            ...
                            >
                              <span
                                className={`${pathUrl === menuItem?.path && !sticky && "lg:!text-black text-primary"} ${pathUrl === menuItem?.path && sticky && "!text-primary"} ${
                                  sticky
                                    ? "lg:text-secondary-foreground text-white"
                                    : "lg:text-secondary"
                                }`}
              ...
              <div className="hidden items-center justify-end pr-16 sm:flex lg:pr-0">
                ...
                <button
                  ...
                  className={`flex h-8 w-8 items-center justify-center text-body-color duration-300 ${sticky ? "dark:text-secondary" : "dark:text-secondary-foreground"}`}
                >
                  <span>
                    <svg
                      viewBox="0 0 16 16"
                    ...
                    <svg
                      viewBox="0 0 23 23"
                      className={`h-[30px] w-[30px] fill-current text-primary dark:hidden ${
                        !sticky && pathUrl === "/" && "text-secondary"
                      }`}
                    >
