const SingleFaq = (props: { question: string; answer: string }) => {
  ...
  return (
    ...
    <div className="mb-12 flex lg:mb-[70px]">
            <div
              className="bg-primary mr-4 flex h-[50px] w-full max-w-[50px] items-center justify-center rounded-xl text-secondary sm:mr-6 sm:h-[60px] sm:max-w-[60px]">
            ...
            <div className="w-full">
              <h3 className="mb-6 text-xl font-semibold text-primary dark:text-primary sm:text-2xl lg:text-xl xl:text-2xl">
                {question}
              </h3>
