  ...
  return (
    <section className="relative z-20 overflow-hidden bg-white pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
      <div className="container">
        <SectionTitle
          subtitle="FAQ"
          title="Alguma Pergunta? Confira"
          paragraph="Configura abaixo as perguntas mais frequentes feitas pelos nossos clientes. Caso não encontre a resposta para sua pergunta, entre em contato conosco."
          width="640px"
          center
        />
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            ...
            <SingleFaq
              ...
              answer="Os nossos planos estão em construção. Por enquanto, a plataforma é gratuita para todos os usuários. Nós iremos te avisar quando os planos estiverem disponíveis. Nos ajude a construir uma plataforma única para o mercado."
            />
            <SingleFaq
              question="O que acontece se eu tiver problemas com o App?"
              answer="Caso você tenha problemas com o App, entre em contato conosco via WhatsApp. Nós iremos te ajudar a resolver o problema o mais rápido possível. Nós estamos sempre disponíveis para te ajudar com suporte 24h."
            />
          </div>

          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="É possível personalizar o meu Website?"
              answer="Sim! Você pode personalizar o seu Website de acordo com a sua marca. Nós iremos oferecer diversos templates posteriormente. Por agora, você tem diversas opções de temas para os seus clientes desfrutarem de um app fácil e moderno de usar. Caso você queira algo mais personalizado, entre em contato conosco via WhatsApp."
            />
            <SingleFaq
